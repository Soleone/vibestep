  ...
  return (
    <main className={activeTab === 'editor' ? 'editing-layout' : undefined}>
      ...
      <aside className="panel">
        ...
        {activeTab === 'editor' && <>
          {beatmapControls}
          <RunFeedbackSummaryCard summary={feedbackSummary} lastRun={lastPlayRun} onDiscardRun={deletePlayRun} />
        </>}
