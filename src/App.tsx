import { ArrowLeft, ArrowLeftToLine, ArrowRightToLine, Check, Circle, CopyPlus, Database, Download, Edit3, FilePlus2, Gamepad2, Headphones, Redo2, Save, Settings, Star, Trash2, Undo2, Upload, X, Zap } from 'lucide-react'
        ...
        <div className="settings-page__shell">
          <header className="settings-page__header">
            <div className="settings-page__title-row">
              <Button type="button" variant="ghost" size="icon" onClick={() => setSettingsOpen(false)} tooltip="Back to workspace" aria-label="Back to workspace"><ArrowLeft /></Button>
              <div><span className="eyebrow">Beat Fiend</span><h1>Settings</h1></div>
            </div>
