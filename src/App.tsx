  ...
  return (
    <main className={activeTab === 'editor' ? 'editing-layout' : undefined}>
      ...
      <aside className="panel">
        ...
        {activeTab === 'editor' && <>
          {beatmapControls}
          <RunFeedbackSummaryCard summary={feedbackSummary} lastRun={lastPlayRun} showLastRunOnly={showLastRunOnly} onShowLastRunOnlyChange={setShowLastRunOnly} onDiscardRun={deletePlayRun} />
        </>}
