...
export type ImportResult = { id: string; title: string; durationMs: number; audioUrl: string; beatmapUrl: string; noteCount: number; sourceUrl?: string; cached?: boolean; builtIn?: boolean; bpm?: number; beatOffsetMs?: number; beatmaps?: SavedBeatmap[] }
